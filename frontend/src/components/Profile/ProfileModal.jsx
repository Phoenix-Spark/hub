  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        ...
        <Modal.Body>
          ...
          <Row>
            <Col md='auto' className="mx-4">
              <Image src={profileData.photo_url} rounded style={{height: '300px', width: '300px'}}/>
            </Col>
            <Col className="d-flex flex-column align-items-center justify-content-around">
              <Row className="d-flex align-items-center">
                <Col md='auto'>
                  <Image src={profileData.logo_url} style={{height: '75px', width: '75px'}}/>
                </Col>
                <Col>
              ...
              <Row>
                <Col className="text-center">
                  <a href={`mailto:${profileData.email}`}>{profileData.email}</a><br/>
                  <a href={`tel:${profileData.contact_number1}`}>{profileData.contact_number1}</a><br/>
                  <a href={`tel:${profileData.contact_number2}`}>{profileData.contact_number2}</a><br/>
                </Col>
              </Row>
            </Col>
          </Row>
        ...
        <Modal.Footer>
          <Button variant="secondary" onClick={() => setProfileModal({show: false, userId: 0})}>
            Close
          </Button>
        </Modal.Footer>
    </Modal>
