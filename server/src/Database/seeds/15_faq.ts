...
export async function seed(knex: Knex) {
  ...
  await knex.schema.raw('TRUNCATE faqs RESTART IDENTITY CASCADE');
  // await knex('faq').del()
  await knex('faqs').insert([
    ...
    },
    {
      ...
      answer:
        'You can join Spark Hub by signing up for an account and becoming a member of our community.',
      asked_by: 2,
      answered_by: 10,
    },
    {
