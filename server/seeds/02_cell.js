...
export async function seed(knex) {
  ...
  await knex('cell').insert([
    ...
    {base_id: 2, cell_name: 'The Forge', external_website: 'https://cell2website.com', cell_mission: 'Cell 2 Mission Statement', contact_number1: 'value', contact_number2: 'value', email: 'cell2@cell2.com', logo_url: './images/placeholder_logo.svg'},
